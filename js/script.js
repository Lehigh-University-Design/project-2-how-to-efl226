document.addEventListener('DOMContentLoaded', () => {
    ...
    if (startSlide) {
        const slideData = [
            { image: "icons/vinyl.png", alt: "Placeholder for Analog Audio concept", title: "", text: "The turntable rotates the vinyl at a steady speed (33⅓ or 45 RPM), moving the stylus steadily inward along the groove." },
            { image: "icons/music.png", alt: "Placeholder for a Turntable", title: "", text: "The stylus vibrates as it traces the groove’s tiny modulations, mirroring the original audio’s amplitude (loudness) and frequency (pitch)" },
            { image: "icons/flash.png", alt: "Placeholder for a record needle", title: "", text: "The cartridge (holding the stylus) converts these mechanical vibrations into a very small electrical signal." },
            { image: "icons/volume-up-interface-symbol.png", alt: "Placeholder for an audio amplifier", title: "", text: "This tiny “phono” signal is first boosted by a phono preamplifier. Then a main amplifier or receiver then further raises the signal level so it can drive speakers. " },
            { image: "icons/speaker.png", alt: "Placeholder for speakers", title: "", text: "Finally, the speakers turn the amplified electrical signal back into sound waves, producing the music we hear. " }
        ];
    ...
    if (setupButtons.length > 0) {
        const setupSlideData = [
            { image: "images/SimpleSetup.png", text: "This first setup is as simple as it gets. All you need is an Orbit with built-in phono preamp and powered speakers. Connect the Orbit to your speaker’s RCA or 3.5 mm AUX input using the included cables and you’re good to go. \n Keep in mind that the simple setup requires powered speakers, which differ from the passive speakers that are mentioned in the next setup. Unsure which type of speakers you have? You can find that lower on this page. " },
            { image: "images/TraditionalSetup.png", text: "First, you connect your Orbit to a stereo receiver (with a dedicated phono input) using the included RCA cables. Next, you connect your stereo receiver to bookshelf or floorstanding passive speakers using speaker wire. The receiver contains both (i) a phono preamp to amplify your turntable’s signal as well as (ii) a power amp to drive your passive speakers. This setup is a good bet if you have a number of sources you want to connect to your speakers." },
